...
{
    public class BassEngine1 : IWaveformPlayer, ISpectrumPlayer
    {
        #region Fields
        private int[] _fxEQ = { 0, 0, 0, 0, 0, 0, 0 };
        private static BassEngine1 instance;
        ...
        public static BassEngine1 Instance
        {
            get
            {
                if (instance == null)
                    instance = new BassEngine1();
                return instance;
            }
        }
        #endregion
        ...
        public void changePitch(float value)
        {
            ...
            Bass.BASS_ChannelSetAttribute(FileStreamHandle, BASSAttribute.BASS_ATTRIB_TEMPO, value * 10 * 12f);
        }
        ...
        private void MyBPMProc(int handle, float bpm, IntPtr user)
        {
            ...
            MainWindow.bpmDisplay2 = bpm.ToString();
